...
public class Globals
{
    ...
    public static function init() : void
    {
        ...
        zonesDict[idv.cjcat.stardustextended.twoD.zones.RectZone] = new DropdownListVO("Rectangle", idv.cjcat.stardustextended.twoD.zones.RectZone, com.plumbee.stardust.view.stardust.twoD.zones.RectZone);
        zonesDict[RectContour] = new DropdownListVO("Rectangle contour", RectContour, RectContourZone);
        zonesDict[idv.cjcat.stardustextended.twoD.zones.CircleZone] = new DropdownListVO("Circle", idv.cjcat.stardustextended.twoD.zones.CircleZone, com.plumbee.stardust.view.stardust.twoD.zones.CircleZone);
